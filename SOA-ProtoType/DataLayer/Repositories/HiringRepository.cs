...
{
    [Export(typeof(IHiringRepository))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class HiringRepository : DataRepositoryBase<Hired>, IHiringRepository
    {
        ...
        public IEnumerable<Hired> GetHiringHistoryByDeveloper(int developerId)
        {
        ...
        public Hired GetCurrentHiringByDeveloper(int developerId)
        {
            using (var dbctx = new XplicitDbContext())
            {
                var query = from hired in dbctx.HiredSet
        ...
        public IEnumerable<Hired> GetHiringHistoryByAccount(int accountId)
        {
            using (var dbctx = new XplicitDbContext())
            {
                var query = from hired in dbctx.HiredSet
        ...
        public IEnumerable<ClientHireInfo> GetCurrentClientHiringInfo()
        {
            using (var dbctx = new XplicitDbContext())
            {
                var query = from hired in dbctx.HiredSet
