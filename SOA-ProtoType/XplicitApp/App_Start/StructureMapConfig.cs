...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(XplicitApp.StructureMapConfig), "Configure")]
	...
	public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
				...
				cfg.AddRegistry(new ActionFilterRegistry(namespacePrefix: "XplicitApp"));
